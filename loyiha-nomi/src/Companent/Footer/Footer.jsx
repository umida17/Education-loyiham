// Faylning tepasiga tarjimalar (mainTranslations) ichiga ushbu footer qismini qo'shib qo'ying:
/*
uz: {
  ...eski tarjimalar,
  footer: {
...
ru: { ... xuddi shunday ruscha ma'nolari ... },
en: { ... xuddi shunday inglizcha ma'nolari ... }
*/
  ...
  <div className="container footer-container">
    ...
    <div className="footer-col footer-about-col">
      ...
      <p className="footer-desc-text">
        {t.footer?.eduDesc || "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet, vestibulum euismod nullam the elementum. Urna, posuere nisi sit gravid."}
      </p>
      <div className="footer-social-wrapper">
        <h4 className="social-title">{t.footer?.followUs || "Follow Us"}</h4>
    ...
    <div className="footer-col">
      <h3 className="footer-col-title">{t.footer?.featLinks || "Feature Links"}</h3>
      <ul className="footer-links-list">
        <li><a href="#about"><span className="arrow-icon">➔</span> {t.footer?.links?.about || "About Us"}</a></li>
        <li><a href="#graduation"><span className="arrow-icon">➔</span> {t.footer?.links?.grad || "Graduation"}</a></li>
        <li><a href="#scholarship"><span className="arrow-icon">➔</span> {t.footer?.links?.schol || "Scholarship"}</a></li>
        <li><a href="#admissions"><span className="arrow-icon">➔</span> {t.footer?.links?.admis || "Admissions"}</a></li>
        <li><a href="#international"><span className="arrow-icon">➔</span> {t.footer?.links?.inter || "International"}</a></li>
        <li><a href="#events"><span className="arrow-icon">➔</span> {t.footer?.links?.events || "Events"}</a></li>
      </ul>
    </div>

    {/* Kolonka 3: Support */}
    <div className="footer-col">
      <h3 className="footer-col-title">{t.footer?.support || "Support"}</h3>
      <ul className="footer-links-list">
        <li><a href="#language"><span className="arrow-icon">➔</span> {t.footer?.links?.lang || "Language"}</a></li>
        <li><a href="#wordpress"><span className="arrow-icon">➔</span> {t.footer?.links?.wp || "WordPress"}</a></li>
        <li><a href="#privacy"><span className="arrow-icon">➔</span> {t.footer?.links?.priv || "Privacy"}</a></li>
        <li><a href="#faqs"><span className="arrow-icon">➔</span> {t.footer?.links?.faqs || "FAQs"}</a></li>
        <li><a href="#support-center"><span className="arrow-icon">➔</span> {t.footer?.links?.supp || "Support"}</a></li>
      </ul>
    </div>

    {/* Kolonka 4: Contact Us */}
    <div className="footer-col footer-contact-col">
      <h3 className="footer-col-title">{t.footer?.contactUs || "Contact Us"}</h3>
